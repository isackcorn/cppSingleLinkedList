...
public:
    ...
    [[nodiscard]] Iterator begin() noexcept {
        return size_ == 0 ? Iterator(nullptr) : Iterator(head_.next_node);
    }
    ...
    [[nodiscard]] ConstIterator begin() const noexcept {
        return size_ == 0 ? ConstIterator(nullptr) : ConstIterator(head_.next_node);
    }
    ...
    void PopFront() noexcept {
        ...
        assert(temp);
        auto temp_to_ins = temp->next_node;
        delete temp;
        head_.next_node = temp_to_ins;
        --size_;
    }
...
private:
    ...
    void Construct(Iterator first, Iterator second) {

        SingleLinkedList temp;

        auto node = &temp.head_;
